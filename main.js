(function () {
  ...
  var translations = {
    fr: {
      ...
      desc_ananas: "Voici mon premier album, en collaboration avec Eutrop. C’est un voyage électronique expérimental à travers plusieurs genres, dont la French touch, la techno et le hip hop.",
      play: "Lecture",
      pause: "Pause",
    ...
    en: {
      ...
      desc_ananas: "Here is my first album, in collaboration with Eutrop. It’s an experimental electronic journey across several genres, including French touch, techno and hip hop.",
      play: "Play",
      pause: "Pause",
